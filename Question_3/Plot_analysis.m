...
set(0, 'DefaultAxesColor', 'w');     % All axes → white
set(0, 'DefaultAxesXColor', 'k');    % Axis lines → black
set(0, 'DefaultAxesYColor', 'k');
set(0, 'DefaultTextColor', 'k');     % Titles, labels → black
set(0, 'DefaultAxesGridColor', [0.8 0.8 0.8]); % Light grid
